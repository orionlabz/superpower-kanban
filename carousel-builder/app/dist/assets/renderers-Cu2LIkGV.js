function t(i){return String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function r(i){return i||""}function $(i){const n=i.layout||"a",e=b[i.template];return(e==null?void 0:e[n])??(e==null?void 0:e.a)??b.dark.a}const u={cover:{a:"Ancorado",b:"Editorial",c:"Linha de corte"},dark:{a:"Stacked",b:"Nº fundo",c:"2 colunas"},steps:{a:"Lista",b:"Numerado",c:"Ícones"},overlay:{a:"Foto topo",b:"Full-bleed"},split:{a:"Padrão"},cta:{a:"Headline",c:"Centrado"}},x=i=>`font-family:'${(i==null?void 0:i.font_display)||"Playfair Display"}',serif;`,p=i=>`font-family:'${(i==null?void 0:i.font_body)||"Inter"}',sans-serif;`,o=i=>`font-family:'${(i==null?void 0:i.font_ui)||"JetBrains Mono"}',monospace;`;function v(i){const n=i.img_position;if(!n)return"";const e=n.x??50,a=n.y??50,l=n.scale??1;return`object-position:${e}% ${a}%;transform:scale(${l});transform-origin:${e}% ${a}%;`}function h(i){const n=(i==null?void 0:i.nav_left)||"CATEGORIA",e=(i==null?void 0:i.nav_right)||"SÉRIE";return`<div style="${o(i)}display:flex;align-items:center;gap:22px;font-size:22px;letter-spacing:.18em;color:#303030;text-transform:uppercase;margin-bottom:96px;">
    ...
    <span style="font-size:22px;letter-spacing:.14em;color:#252525;text-transform:uppercase;">${t(e.toUpperCase())}</span>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="${p(e)}font-size:27px;color:#777;line-height:1.5;">${f}</div>
        </div>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="display:flex;flex-direction:column;">
            ...
            <div style="${p(e)}font-size:27px;color:#666;line-height:1.5;">${d}</div>
          </div>
        </div>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="flex:1;display:flex;flex-direction:column;justify-content:center;">
            ...
            <div style="${p(e)}font-size:27px;color:#666;line-height:1.5;">${g}</div>
          </div>
        ...
        <div style="flex:0 0 52%;display:flex;flex-direction:column;padding:54px 52px 60px 76px;">
          ...
          <div style="${p(e)}font-size:27px;color:#777;line-height:1.5;margin-bottom:auto;">${s}</div>
          ${y(e)}
        </div>
        <div style="flex:0 0 48%;overflow:hidden;">${a}</div>
          ...
          <span style="${p(e)}color:#555;font-size:27px;flex-shrink:0;">·</span>
          <span style="${p(e)}font-size:27px;color:#666;line-height:1.45;">${t(c)}</span>
        ...
        <div style="${p(e)}font-size:27px;color:#666;line-height:1.5;margin-bottom:32px;">${l}</div>
        <div style="margin-bottom:24px;">${a}</div>
        <div style="${p(e)}font-size:27px;color:#555;line-height:1.5;margin-bottom:auto;">${s}</div>
        ${y(e)}
          ...
          <span style="${p(e)}font-size:27px;color:#3a3a3a;line-height:1.45;">${t(m)}</span>
        ...
        <div style="flex:1;display:flex;flex-direction:column;position:relative;">
          ...
          <div style="${p(e)}font-size:27px;color:#505050;line-height:1.6;margin-bottom:48px;">${d}</div>
          <div style="margin-bottom:0;">${a}</div>
          <div style="margin-top:auto;padding-top:32px;">
            <div style="${x(e)}font-size:27px;color:#2e2e2e;line-height:1.5;font-style:italic;">${g}</div>
          </div>
        </div>
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
          ...
          <span style="${p(e)}color:#555;font-size:27px;flex-shrink:0;">·</span>
          <span style="${p(e)}font-size:27px;color:#666;line-height:1.45;">${t(m)}</span>
        ...
        <div style="${p(e)}font-size:27px;color:#666;line-height:1.5;margin-bottom:32px;">${d}</div>
        <div style="margin-bottom:24px;">${a}</div>
        <div style="${p(e)}font-size:27px;color:#3a3a3a;line-height:1.5;margin-bottom:auto;">${g}</div>
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
          ...
          <span style="${p(e)}font-size:27px;font-weight:500;color:#fff;">${t(s.label)}:</span>
          <span style="${p(e)}font-size:27px;color:#666;"> ${r(s.text_html||t(s.text||""))}</span>
        ...
        ${y(e)}
          ...
          <div style="flex:1;">
            ...
            <div style="${p(e)}font-size:24px;color:#444;line-height:1.5;">${r(g.text_html||t(g.text||""))}</div>
          </div>
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
          ...
          <div style="${p(e)}font-size:22px;color:#3a3a3a;line-height:1.5;">${r(d.text_html||t(d.text||""))}</div>
        ...
        <div style="flex:1;padding:32px 62px 60px;display:flex;flex-direction:column;">
          ...
          <div style="${p(e)}font-size:24px;color:#666;line-height:1.5;margin-bottom:auto;">${l}</div>
          ${y(e)}
        </div>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="${p(e)}font-size:27px;color:#666;line-height:1.5;margin-bottom:36px;">${g}</div>
          <div style="display:flex;justify-content:space-between;align-items:center;">
        ...
        <div style="${p(e)}font-size:27px;color:#444;line-height:1.5;margin-bottom:60px;">${c}</div>
        ...
        <div style="${p(e)}font-size:27px;color:#3a3a3a;line-height:1.6;margin-bottom:60px;">${c}</div>
