function n(i){return String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function r(i){return i||""}function w(i){const o=i.layout||"a",e=z[i.template];return(e==null?void 0:e[o])??(e==null?void 0:e.a)??z.dark.a}const k={cover:{a:"Ancorado",b:"Editorial",c:"Linha de corte"},dark:{a:"Stacked",b:"Nº fundo",c:"2 colunas"},steps:{a:"Lista",b:"Numerado",c:"Ícones"},overlay:{a:"Foto topo",b:"Full-bleed"},split:{a:"Padrão"},cta:{a:"Headline",c:"Centrado"}},f=i=>`font-family:'${(i==null?void 0:i.font_display)||"Playfair Display"}',serif;`,d=i=>`font-family:'${(i==null?void 0:i.font_body)||"Inter"}',sans-serif;`,t=i=>`font-family:'${(i==null?void 0:i.font_ui)||"JetBrains Mono"}',monospace;`,h=(i,o)=>Math.round((+(i==null?void 0:i.font_size_headline)||72)*o/72),p=(i,o)=>Math.round((+(i==null?void 0:i.font_size_body)||36)*o/36),y=i=>+(i==null?void 0:i.line_height_headline)||1.05,g=i=>+(i==null?void 0:i.line_height_body)||1.5;function b(i){const o=i.img_position;if(!o)return"";const e=o.x??50,a=o.y??50,l=o.scale??1;return`object-position:${e}% ${a}%;transform:scale(${l});transform-origin:${e}% ${a}%;`}function u(i){const o=(i==null?void 0:i.nav_left)||"CATEGORIA",e=(i==null?void 0:i.nav_right)||"SÉRIE";return`<div style="${t(i)}display:flex;align-items:center;gap:22px;font-size:22px;letter-spacing:.18em;color:#303030;text-transform:uppercase;margin-bottom:96px;">
    <span>${n(o)}</span>
    <div style="flex:1;height:1px;background:#1e1e1e;"></div>
    <span>${n(e)}</span>
  </div>`}function _(i){const o=(i==null?void 0:i.brand_symbol)||"⬥",e=(i==null?void 0:i.brand_name)||"Marca";return`<div style="${t(i)}display:flex;justify-content:space-between;align-items:center;margin-top:auto;padding-top:36px;">
    ...
    <span style="font-size:22px;letter-spacing:.14em;color:#252525;text-transform:uppercase;">${n(e.toUpperCase())}</span>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="${f(e)}font-size:${h(e,84)}px;line-height:${y(e)};font-weight:400;color:#fff;margin-bottom:28px;">
            ${x}
          </div>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="display:flex;flex-direction:column;">
            ...
            <div style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};">${c}</div>
          </div>
        </div>
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="flex:1;display:flex;flex-direction:column;justify-content:center;">
            ...
            <div style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};">${v}</div>
          </div>
        ...
        <div style="flex:0 0 52%;display:flex;flex-direction:column;padding:54px 52px 60px 76px;">
          ${u(e)}
          <div style="${f(e)}font-size:${h(e,62)}px;line-height:${y(e)};font-weight:400;color:#fff;margin-bottom:28px;">
            ${l}
          </div>
          <div style="${d(e)}font-size:${p(e,36)}px;color:#777;line-height:${g(e)};margin-bottom:auto;">${s}</div>
          ${_(e)}
        </div>
        <div style="flex:0 0 48%;overflow:hidden;">${a}</div>
          ...
          <span style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};">${n(x)}</span>
        ...
        <div style="${f(e)}font-size:${h(e,62)}px;line-height:${y(e)};font-weight:400;color:#fff;margin-bottom:36px;">${n(i.section_title)}</div>
        <div style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};margin-bottom:32px;">${l}</div>
        <div style="margin-bottom:24px;">${a}</div>
        <div style="${d(e)}font-size:${p(e,36)}px;color:#555;line-height:${g(e)};margin-bottom:auto;">${s}</div>
        ${_(e)}
          ...
          <span style="${d(e)}font-size:${p(e,36)}px;color:#3a3a3a;line-height:${g(e)};">${n($)}</span>
         </div>`).join(""),l=(e==null?void 0:e.nav_left)||"CATEGORIA",s=(e==null?void 0:e.nav_right)||"SÉRIE",x=(e==null?void 0:e.brand_symbol)||"⬥",m=(e==null?void 0:e.brand_name)||"Marca",c=r(i.body_html||n(i.body||"")),v=r(i.conclusion_html||n(i.conclusion||""));return`<div style="width:1080px;height:1350px;background:#060606;display:flex;flex-direction:column;padding:54px 76px 80px;position:relative;overflow:hidden;">
        <div style="${f(e)}position:absolute;top:-20px;right:40px;font-size:480px;color:#111;line-height:1;user-select:none;pointer-events:none;letter-spacing:-.02em;">${n(i.section_number||"")}</div>
        ...
        <div style="flex:1;display:flex;flex-direction:column;position:relative;">
          ...
          <div style="${f(e)}font-size:${h(e,72)}px;line-height:${y(e)};font-weight:400;color:#e8e8e8;margin-bottom:40px;">${n(i.section_title)}</div>
          <div style="${d(e)}font-size:${p(e,36)}px;color:#505050;line-height:${g(e)};margin-bottom:48px;">${c}</div>
          <div style="margin-bottom:0;">${a}</div>
          <div style="margin-top:auto;padding-top:32px;">
            <div style="${f(e)}font-size:${p(e,36)}px;color:#2e2e2e;line-height:${g(e)};font-style:italic;">${v}</div>
          </div>
        </div>
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
          ...
          <span style="${d(e)}color:#555;font-size:${p(e,36)}px;flex-shrink:0;">·</span>
          <span style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};">${n($)}</span>
        ...
        <div style="display:flex;gap:52px;align-items:flex-start;margin-bottom:52px;border-top:1px solid #1a1a1a;padding-top:36px;">
          <div style="flex:0 0 160px;">
            ...
            <div style="${f(e)}font-size:120px;color:#161616;line-height:1;letter-spacing:-.02em;">${n(i.section_number||"")}</div>
          </div>
          <div style="flex:1;padding-top:8px;">
            <div style="${f(e)}font-size:${h(e,62)}px;line-height:${y(e)};font-weight:400;color:#fff;">${n(i.section_title)}</div>
          </div>
        </div>
        <div style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};margin-bottom:32px;">${c}</div>
        <div style="margin-bottom:24px;">${a}</div>
        <div style="${d(e)}font-size:${p(e,36)}px;color:#3a3a3a;line-height:${g(e)};margin-bottom:auto;">${v}</div>
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
        ...
        ${u(e)}
        ${i.section_title?`<div style="${f(e)}font-size:${h(e,48)}px;font-weight:400;color:#fff;margin-bottom:36px;">${n(i.section_title)}</div>`:""}
        <div style="flex:1;">${a}</div>
        <div style="${f(e)}font-size:${h(e,62)}px;font-weight:400;color:#fff;line-height:${y(e)};margin-bottom:auto;">
          ${l}
        </div>
        ${_(e)}
      </div>`},b(i,o,e){const a=(i.steps||[]).map(v=>{var $;return`<div style="display:flex;align-items:baseline;gap:36px;margin-bottom:32px;">
          <span style="${f(e)}font-size:100px;color:#161616;line-height:1;flex-shrink:0;width:100px;">${n((($=v.label.match(/\d+/))==null?void 0:$[0])||"")}</span>
          <div style="flex:1;">
            <div style="${t(e)}font-size:22px;font-weight:500;color:#aaa;letter-spacing:.06em;margin-bottom:6px;">${n(v.label.replace(/^\d+[:,.]?\s*/,""))}</div>
            <div style="${d(e)}font-size:${p(e,32)}px;color:#444;line-height:${g(e)};">${r(v.text_html||n(v.text||""))}</div>
          </div>
        ...
        <div style="flex:1;">${a}</div>
        <div style="${f(e)}font-size:${h(e,62)}px;font-weight:400;color:#fff;line-height:${y(e)};margin-bottom:auto;padding-top:24px;">
          ${c}
        </div>
        <div style="display:flex;justify-content:space-between;align-items:center;padding-top:36px;">
          <span style="${t(e)}font-size:22px;color:#252525;">${n(x)} ${n(m)}</span>
      ...
      </div>`},c(i,o,e){const a=i.steps||[],l=(e==null?void 0:e.nav_left)||"CATEGORIA",s=(e==null?void 0:e.nav_right)||"SÉRIE",x=a.slice(0,4).map(c=>{let v='<div style="width:48px;height:48px;border-radius:50%;border:1px solid #1e1e1e;margin-bottom:20px;"></div>';return c.icon&&(c.icon.type==="lucide"&&c.icon.svg?v=`<div style="margin-bottom:20px;">${c.icon.svg}</div>`:c.icon.type==="upload"&&c.icon.src&&(v=`<img src="${n(c.icon.src)}" style="width:48px;height:48px;object-fit:contain;margin-bottom:20px;">`)),`<div style="background:#0d0d0d;border-radius:12px;padding:40px 36px;display:flex;flex-direction:column;">
          ${v}
          <div style="${t(e)}font-size:20px;color:#888;font-weight:500;letter-spacing:.04em;margin-bottom:12px;">${n(c.label.replace(/^\d+[:,.]?\s*/,""))}</div>
          <div style="${d(e)}font-size:${p(e,30)}px;color:#3a3a3a;line-height:${g(e)};">${r(c.text_html||n(c.text||""))}</div>
        ...
        <div style="flex:1;padding:32px 62px 60px;display:flex;flex-direction:column;">
          ${u(e)}
          <div style="${t(e)}font-size:22px;letter-spacing:.18em;color:#333;text-transform:uppercase;margin-bottom:12px;">${n(i.section_number)}</div>
          <div style="${f(e)}font-size:${h(e,62)}px;font-weight:400;color:#fff;line-height:${y(e)};margin-bottom:16px;">${n(i.section_title)}</div>
          <div style="${f(e)}font-size:${p(e,36)}px;font-weight:400;font-style:italic;color:#aaa;margin-bottom:20px;">${n(i.headline)}</div>
          <div style="${d(e)}font-size:${p(e,32)}px;color:#666;line-height:${g(e)};margin-bottom:auto;">${l}</div>
          ${_(e)}
        </div>
      </div>`},b(i,o,e){const a=o?`<img src="${o}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;${b(i)}">`:'<div style="position:absolute;inset:0;background:linear-gradient(160deg,#2a3540,#1a2228);"></div>',l=(e==null?void 0:e.brand_symbol)||"⬥",s=(e==null?void 0:e.brand_name)||"Marca",x=(e==null?void 0:e.nav_left)||"CATEGORIA",m=(e==null?void 0:e.nav_right)||"SÉRIE",c=r(i.headline_html||(i.headline?n(i.headline)+(i.headline_italic?" <em>"+n(i.headline_italic)+"</em>":""):"")),v=r(i.body_html||n(i.body||""));return`<div style="width:1080px;height:1350px;background:#000;position:relative;overflow:hidden;">
        ${a}
        ...
        <div style="position:absolute;inset:0;display:flex;flex-direction:column;padding:54px 76px 80px;">
          ...
          <div style="${f(e)}font-size:${h(e,72)}px;line-height:${y(e)};font-weight:400;color:#fff;margin-bottom:28px;">
            ${c}
          </div>
          <div style="${d(e)}font-size:${p(e,36)}px;color:#666;line-height:${g(e)};margin-bottom:36px;">${v}</div>
          <div style="display:flex;justify-content:space-between;align-items:center;">
        ...
        <div style="${f(e)}font-size:${h(e,84)}px;line-height:${y(e)};font-weight:400;font-style:italic;color:#fff;margin-bottom:40px;">
          ${s}
        </div>
        <div style="${d(e)}font-size:${p(e,36)}px;color:#444;line-height:${g(e)};margin-bottom:60px;">${x}</div>
        ...
        <div style="${f(e)}font-size:${h(e,84)}px;line-height:${y(e)};font-weight:400;color:#fff;margin-bottom:36px;">
          ${s}
        </div>
        <div style="width:80px;height:1px;background:#1c1c1c;margin-bottom:36px;"></div>
        <div style="${d(e)}font-size:${p(e,36)}px;color:#3a3a3a;line-height:${g(e)};margin-bottom:60px;">${x}</div>
